...
conn = sqlite3.connect(to_server)
c = conn.cursor()
conn.commit()
...
c.execute("""INSERT INTO `agents` (`AGENT_CODE`, `AGENT_NAME`, `WORKING_AREA`, `COMMISSION`, `PHONE_NO`, `COUNTRY`) VALUES
...
c.execute("""INSERT INTO company (`COMPANY_ID`, `COMPANY_NAME`, `COMPANY_CITY`) VALUES
...
c.execute("""INSERT INTO `customer` (`CUST_CODE`, `CUST_NAME`, `CUST_CITY`, `WORKING_AREA`, `CUST_COUNTRY`, `GRADE`, `OPENING_AMT`, `RECEIVE_AMT`, `PAYMENT_AMT`, `OUTSTANDING_AMT`, `PHONE_NO`, `AGENT_CODE`) VALUES
...
c.execute("""INSERT INTO `orders` (`ORD_NUM`, `ORD_AMOUNT`, `ADVANCE_AMOUNT`, `ORD_DATE`, `CUST_CODE`, `AGENT_CODE`, `ORD_DESCRIPTION`) VALUES
...
c.execute("""CREATE TABLE IF NOT EXISTS `daysorder` (
  `ORD_NUM` numeric,
  `ORD_AMOUNT` numeric,
  `ADVANCE_AMOUNT` numeric,
  `ORD_DATE` date ,
...
c.execute("""CREATE TABLE IF NOT EXISTS `despatch` (
  `DES_NUM` text,
  `DES_DATE` date ,
  `DES_AMOUNT` numeric,
  `ORD_NUM` numeric,
...
c.execute("""INSERT INTO `daysorder` (`ORD_NUM`, `ORD_AMOUNT`, `ADVANCE_AMOUNT`, `ORD_DATE`, `CUST_CODE`, `AGENT_CODE`, `ORD_DESCRIPTION`) VALUES
('200107', '4500.00', '900.00', '2008-08-30', 'C00007', 'A010', 'SOD\r'),
...
c.execute("""INSERT INTO `foods` (`ITEM_ID`, `ITEM_NAME`, `ITEM_UNIT`, `COMPANY_ID`) VALUES
('1', 'Chex Mix', 'Pcs', '16\r'),
('6', 'Cheez-It', 'Pcs', '15\r'),
...
c.execute("""CREATE TABLE IF NOT EXISTS `listofitem` (
  `ITEMCODE` text,
  `ITEMNAME` text,
  `BATCHCODE` text,
  `CONAME` text
...
c.execute("""INSERT INTO `listofitem` (`ITEMCODE`, `ITEMNAME`, `BATCHCODE`, `CONAME`) VALUES
